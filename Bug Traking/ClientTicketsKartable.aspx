<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="ClientTicketsKartable.aspx.cs" Inherits="Bug_Traking.ClientTicketsKartable" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<link rel="stylesheet" href="jspc-gray.css" />
	<script type="text/javascript" src="js-persian-cal.min.js"></script>
        <span>کارتابل گزارشات</span>



    <div class="DivSetting">
        <table style="border:solid 1px #ff6a00;margin-top:5px;margin-bottom:5px;">
            <tr>
                <td>جستجو با عنوان : </td>
                <td><asp:TextBox ID="txtCode" CssClass="txtSearch" runat="server"></asp:TextBox></td>
                <td>جستجو با تاریخ ثبت : </td>
                <td><input type="text" id="txtDate" name='txtDate' class="txtSearch" /></td>
                <td><asp:Button ID="btnSearch2" class="btnSearch" runat="server" Text="بگرد" OnClick="btnSearch2_Click" /></td>
           </tr>
        </table>
    </div>
    	...
    	<table id="tblCartabl" style="width:100%;margin-top:5px;margin-bottom:5px;">
        	<tr style="font-weight:bold;background:url(pic/LoginBG2.png);color:#FFF;">
                <td>انتخاب</td>
                <td>کد</td>
                ...
                <asp:Repeater ID="Repeater3" runat="server">
                        <ItemTemplate>
                            <tr mohsenID='<%# Eval("id") %>' class="ttr" style='background:url(pic/LoginBG3.png);<%# Eval("Part") %>'>
                                <td>
                                ...
                                <td>
                                    <a href='ClientTiketShow.aspx?id=<%# Eval("id") %>'><input type='button' value='نمایش' class='ShowBtn' /></a>
                                </td>
                            </tr>
                        </ItemTemplate>
                </asp:Repeater>
    ...
    <div class="DivSetting">
        ...
        <div style="margin-right:15px;padding:5px;width:auto;float:right;font-size:12px;">
            <table>
                <tr>
                    <td>نمایش پوشه</td>
                    <td><asp:DropDownList ID="drpShowFolder" class="drpSendTo2" runat="server"></asp:DropDownList></td>
                    <td><asp:Button ID="btnShowFolder" class="ShowBtn" runat="server" Text="نمایش" OnClick="btnShowFolder_Click" /></td>
                </tr>
            </table>
        </div>
        <div style="margin-right:15px;padding:5px;width:auto;float:right;font-size:12px;">
