<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminService.aspx.cs" Inherits="Bug_Traking.AdminService" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <span>مدیریت زیر سرویس ها</span>
    <table>
        	<tr>
            	<td>نام</td>
            ...
            <tr>
            	<td>زیر سیستم</td>
                <td><asp:DropDownList style="width:261px;" ID="drpSsystem" class="txt" runat="server"></asp:DropDownList></td>
            </tr>
        	<tr>
     ...
     <table>
            ...
            <tr>
            	<td>زیر سیستم</td>
                <td><asp:DropDownList style="width:261px;" ID="drpSsystemEdit" class="txt" runat="server"></asp:DropDownList></td>
            </tr>
        	<tr>
