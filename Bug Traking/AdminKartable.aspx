<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminKartable.aspx.cs" Inherits="Bug_Traking.AdminKartable" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="DivSetting">
        <table style="border:solid 1px #00ffff;margin-top:5px;margin-bottom:5px;">
            <tr>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div id="ConfirmDialog2" class="AllHide">
        <div class="ConfirmDialog">
            ...
            <asp:Button style="padding:10px;padding-right:20px;padding-left:20px;" ID="Button1" class="ShowBtn" runat="server" OnClick="Button1_Click" Text="ایجاد" />
        </div>
     </div>
</asp:Content>
