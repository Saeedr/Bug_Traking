<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminSheda.aspx.cs" Inherits="Bug_Traking.AdminSheda" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <span>مدیریت شدت ها</span>
    <table>
        	<tr>
            	<td>عنوان</td>
                <td><asp:TextBox ID="txtTickatAddTitle" class="txt" runat="server"></asp:TextBox></td>
                <td><asp:RequiredFieldValidator style="width:0px;height:0px;display:inline;float:right;" ID="RequiredFieldValidator2" ValidationGroup="valid1" ControlToValidate="txtTickatAddTitle" runat="server" SetFocusOnError="true"></asp:RequiredFieldValidator></td>
     ...
     <table>
        	<tr>
                ...
                <td><asp:RequiredFieldValidator style="width:0px;height:0px;display:inline;float:right;" ID="RequiredFieldValidator1" ValidationGroup="valid2" ControlToValidate="txtEdit" runat="server" SetFocusOnError="true"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
            	<td>عنوان</td>
