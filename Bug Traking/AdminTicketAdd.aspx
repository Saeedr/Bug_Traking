<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="AdminTicketAdd.aspx.cs" Inherits="Bug_Traking.AdminTicketAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <link href="jquery.auto-complete.css" rel="stylesheet" />
        ...
        <table>
        	...
        	<tr>
            	<td>اولویت</td>
                <td><asp:DropDownList ID="drpTickatAddPriority" style="width:261px;" class="txt" runat="server"></asp:DropDownList></td>
            </tr>

            <tr>
            	<td>شدت خطا</td>
                <td><asp:DropDownList ID="drpShedat" style="width:261px;" class="txt" runat="server"></asp:DropDownList></td>
            </tr>
        	<tr>
            	<td>پروژه</td>
                <td><asp:DropDownList ID="drpTickatAddProject" style="width:261px;" class="txt" runat="server" onchange="FillZirSystem();" ></asp:DropDownList></td>
            </tr>
            
        	<tr>
            	<td>زیرسیستم</td>
                <td><asp:DropDownList ID="drpTickatAddSsystem" style="width:261px;" class="txt" runat="server" onchange="FillService();" ></asp:DropDownList></td>
            </tr>
            
        	<tr>
            	<td>سرویس</td>
                <td><asp:DropDownList ID="drpTickatAddService" style="width:261px;" class="txt" runat="server" onchange="FillPart();" ></asp:DropDownList></td>
            </tr>
            
        	<tr>
            	<td>قسمت</td>
                <td><asp:DropDownList ID="drpTickatAddPart" style="width:261px;" class="txt" runat="server" onchange="FillCategory();" ></asp:DropDownList></td>
            </tr>
            
        	<tr>
            	<td>موضوع باگ</td>
                <td><asp:DropDownList ID="drpTickatAddCategory" style="width:261px;" class="txt" runat="server" AutoPostBack="True"></asp:DropDownList></td>
            </tr>
            ...
            <tr>
            	<td>نام دانشگاه</td>
                <td><asp:DropDownList ID="drpUniName" style="width:261px;" onchange="FillShabakeShahrestan();" class="txt" runat="server" ></asp:DropDownList></td>
            </tr>

            <tr>
            	<td>نام شبکه شهرستان</td>
                <td><asp:DropDownList ID="drpShabakeShahrestan" style="width:261px;" class="txt" runat="server" onchange="FillMarkazBehdaaht();" ></asp:DropDownList></td>
            </tr>

            <tr>
            	<td>مرکز بهداشت درمان</td>
                <td><asp:DropDownList ID="drpMarkazBehdaaht" style="width:261px;" class="txt" runat="server" onchange="FillKhaneBehdasht();" ></asp:DropDownList></td>
            </tr>

            <tr>
            	<td>خانه | پایگاه بهداشت</td>
                <td><asp:DropDownList ID="drpKhaneBehdasht" style="width:261px;" class="txt" runat="server" onchange="Filltxt8Code();" ></asp:DropDownList></td>
            </tr>
	...
	<div id="wrapper" runat="server">
       <span style="float:right;width:5px;background:none;"></span> <input id='inputTagator' style="width:261px;padding:2px;" name='inputTagator' />
            ...
            <tr>
            	<td>ارجاع شود به :</td>
                <td><asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Vertical"></asp:CheckBoxList></td>
            </tr>

             <tr>
            	<td>پیگیری کننده :</td>
                <td><asp:DropDownList ID="drpErja" style="width:261px;" class="txt" runat="server" ></asp:DropDownList></td>
             </tr>
            
        	<tr>
            	<td colspan="2" style="text-align:center"><asp:Button id="btnTicketSend"  class="BtnSubmit" runat="server" Text="ارسال تیکت" ValidationGroup="valid" OnClick="btnTicketSend_Click" />
                    <br />
