<%@ Page Title="" Language="C#" MasterPageFile="~/Support.Master" AutoEventWireup="true" CodeBehind="SupportSearch2.aspx.cs" Inherits="Bug_Traking.SupportSearch2" %>
...
<link rel="stylesheet" href="jspc-gray.css" />
	<script type="text/javascript" src="js-persian-cal.min.js"></script>
        ...
        <table style="border:solid 1px #00ffff;margin-top:10px;margin-bottom:5px;padding:5px;">
            ...
            <tr>
                <td colspan="4" style="text-align:center;"><asp:Button ID="btnSearch2" class="btnSearch" runat="server" Text="بگرد" OnClick="btnSearch2_Click1" /></td>
            </tr>
        </table>
