<%@ Page Title="" Language="C#" MasterPageFile="~/Support.Master" AutoEventWireup="true" CodeBehind="SupportTiketShow.aspx.cs" Inherits="Bug_Traking.SupportTiketShow" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    	...
    	<table cellspacing="5" id="tblShowTicket" style="width:90%;margin:auto;;margin-top:5px;margin-bottom:5px;text-align:center;">
        	...
        	<tr >
                ...
                <td style="text-align:right;padding-right:10px;"><asp:DropDownList style="width:261px;" ID="litCategori" class="txt" runat="server"></asp:DropDownList>
            ...
            <tr >
            	<td style="font-weight:bold;background:url(pic/LoginBG2.png);color:#FFF;"><br />توضیحات حل خطا<br /><br /></td>
                <td style="text-align:right;padding-right:10px;"><asp:TextBox TextMode="MultiLine" ID="txtTickatAddDet" runat="server" class="txt" style="height:100px;max-height:100px;max-width:250px;"></asp:TextBox></td>
            </tr>
            <tr>
            	<td>توضیحات حل خطا</td>
                <td style="text-align:right;padding-right:10px;"><asp:DropDownList style="width:261px;" ID="drpKhataOK" class="txt" runat="server"></asp:DropDownList></td>
            </tr>
            <tr >
            ...
            <tr style="background:none;">
            	<td colspan="2"><a href="SupportSearch.aspx"><input type="button" value="بازگشت" style="padding-right:10px;padding-left:10px;" class="btnSearch" /></a>
                    ...
                    <asp:Button ID="Button1" runat="server" style="padding-right:10px;padding-left:10px;" class="btnSearch" Text="افزودن توضیحات حل خطا و بستن تیکت" OnClick="Button1_Click" />
            	</td>
            </tr>
        </table>
        <span>خطاهای مشابه</span>
