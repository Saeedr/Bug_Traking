<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminTicketOK.aspx.cs" Inherits="Bug_Traking.AdminTicketOK" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <span>مدیریت عناوین حل خطا</span>
    <table>
        	<tr>
            	<td>توضیحات</td>
            ...
            <tr>
            	<td>بخش</td>
                <td><asp:DropDownList style="width:261px;" ID="drpPart" class="txt" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpPart_SelectedIndexChanged"></asp:DropDownList></td>
            </tr>
            <tr>
            	<td>موضوع</td>
                <td><asp:DropDownList style="width:261px;" ID="drpCetrgori" class="txt" runat="server"></asp:DropDownList></td>
            </tr>
        	<tr>
    ...
    <table>
            ...
            <tr>
            	<td>بخش</td>
                <td><asp:DropDownList style="width:261px;" ID="drpPartEdit" class="txt" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpPartEdit_SelectedIndexChanged"></asp:DropDownList></td>
            </tr>
            <tr>
            	<td>موضوع</td>
