<%@ Page Title="" Language="C#" MasterPageFile="~/Support.Master" AutoEventWireup="true" CodeBehind="SupportPosition.aspx.cs" Inherits="Bug_Traking.SupportPosition" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            <span>مدیریت سمت ها</span>
    <table>
        	<tr>
            	<td>عنوان</td>
